...
# I copied this file from the python-vlc install because someone on the iternet told me to do so
import logging
    ...
    if sys.platform.startswith('win'):
        ...
        if p is None:
            ...
            if plugin_path is not None:  # try loading
                ...
                ctypes.windll.kernel32.SetDllDirectoryW(None)  # FIXME
                if 'PyInstallerCDLL' in ctypes.CDLL.__name__:
                    print("Pyinstaller Workaround used")
